...
#define CONFIG_ESP_RMAKER_READ_MQTT_HOST_FROM_CONFIG 1
#define CONFIG_ESP_RMAKER_READ_NODE_ID_FROM_CERT_CN 1
...
#define CONFIG_ESP_RMAKER_LIB_AWS_IOT 1
#define CONFIG_ESP_RMAKER_MQTT_GLUE_LIB 2
